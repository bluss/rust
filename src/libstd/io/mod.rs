...
/// trait.
///
/// Please note that `Read` is implemented for both unbuffered as well as buffered
/// readers; using a buffered reader can be important to avoid system call
/// overhead when using many calls to `read`.
///
/// # Examples
///
